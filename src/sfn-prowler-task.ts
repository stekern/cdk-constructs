  ...
  constructor(scope: constructs.Construct, id: string, props: Props) {
    ...
    taskDefinition.addContainer("main", {
      ...
      image: ecs.ContainerImage.fromRegistry(
        ...
        "toniblyx/prowler:5.43.0@sha256:cf1ee9fc5b677bff8e0e35af7167585b95eb25ba5ffedfbfc52ddd13dc306dd0",
      ),
      command: [
        "aws",
    ...
    taskDefinition.taskRole.attachInlinePolicy(
      new iam.Policy(this, "ProwlerAdditionalPolicy", {
        statements: [
          ...
          // Based on https://github.com/prowler-cloud/prowler/blob/5.43.0/permissions/prowler-additions-policy.json
          new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
              "account:Get*",
